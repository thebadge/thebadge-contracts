...
library LibDiamond {
    ...
    struct DiamondStorage {
         ...
         * =========================
         */
        string greeterMessage;
        uint256 registerUserProtocolFee;
    ...
    /**
     * =========================
     * Getters and Setters custom states
     * =========================
     */

    function getGreeting() internal view returns (string memory) {
        return diamondStorage().greeterMessage;
    }

    function setGreeting(string memory _greeting) internal {
        DiamondStorage storage ds = diamondStorage();
        ds.greeterMessage = _greeting;
    }

    function getFeeCollector() internal view returns (address) {
        return diamondStorage().feeCollector;
    }

    function getRegisterUserProtocolFee() internal view returns (uint256) {
        return diamondStorage().registerUserProtocolFee;
    }
